...
public class ProjectICreativeTab {
	...
	public static final CreativeTabs tab_RockIgneous	= new CreativeTabs("IgneousRocks")  	{@Override public Item getTabIconItem(){return Item.getItemFromBlock(Blocks.stone);} };
	public static final CreativeTabs tab_RockSedimentary= new CreativeTabs("SedimentaryRocks")  {@Override public Item getTabIconItem(){return Item.getItemFromBlock(Blocks.stone);} };
	public static final CreativeTabs tab_RockMetamorphic= new CreativeTabs("MetamorphicRocks")  {@Override public Item getTabIconItem(){return Item.getItemFromBlock(Blocks.stone);} };
	//public static final CreativeTabs tab_Savagery	= new CreativeTabs("SavageryAge")  {@Override public Item getTabIconItem(){return Item.getItemFromBlock(Blocks.furnace);} };
